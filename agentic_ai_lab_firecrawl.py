...
# ========== CONFIGURATION ==========
FIRECRAWL_API_KEY = 'fc-be6474a3762d4fcdbb9e6d24fd6f7e5d'  # Replace with your key
...
def collect_data_from_url(url):
    ...
    try:
        ...
        try:
            ...
            print("response conetent:", response.text)
        raise
    data = response.json()
...
def main():
    ...
    url = input("Enter the URL to collect the data from: ")
